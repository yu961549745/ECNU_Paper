...
\subsection{\Painleve{}展开方法}
\begin{frame}
\frametitle{\Painleve{}展开方法}
\end{frame}
...
\item PAnalyze: 在\Painleve{}展开方法中的应用
\end{enumerate}
\end{frame}
...
\subsection{PAnalyze: 在\Painleve{}展开方法中的应用}
\begin{frame}
\frametitle{PAnalyze: 在\Painleve{}展开方法中的应用}
\end{frame}
