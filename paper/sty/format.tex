...
% 封面下划线长度 
\newcommand{\mcc}[1]{\multicolumn{1}{c}{\underline{\makebox[13em][l]{#1}}}}
\newcommand{\mce}[1]{\multicolumn{1}{c}{\underline{\makebox[18em][l]{#1}}}}
...
\begin{titlepage}
  ...
  \includegraphics[width=0.15\textwidth]{fig/ecnu_logo}}\ \
  \includegraphics[width=0.75\textwidth,height=5em]{fig/ecnu}
