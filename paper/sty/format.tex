...
\begin{titlepage}
  ...
  \begin{center}
  \mbox{
    \includegraphics[width=5em,height=5em]{sty/ecnu_logo.pdf}
  }
  \mbox{
    \includegraphics[width=0.75\textwidth,height=5em]{sty/ecnu.pdf} 
  }
...

  {
    ...
    \begin{varwidth}[t]{.82\linewidth}\linespread{1.4}\zihao{2} \@etitle \linebreak\end{varwidth}
  }
