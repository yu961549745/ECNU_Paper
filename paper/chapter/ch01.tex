...
\section{本文的选题和主要工作}
随着计算机代数系统的不断发展, 衍生了许多构造非线性系统精确解的机械化方法. 本文在前人工作的基础上, 针对非线性系统精确解的相关机械化算法进行研究, 开展了如\reffig{outline}所示的一些工作. 在\reffig{outline}中, 椭圆表示方法\D 矩形表示软件包. 其中 矩形内部的第一行是软件包的名称, 第二行是软件包用途的简要说明. 这些软件包可以分为 4 类: 黄色的NEM\D PExpand 和 PGSolve 是基础工具; 蓝色的 NLREPS 用于求解差分方程; 绿色的 TwSolver 和 NS1L 用于求解微分方程; 粉色的 IntSimplify 用于进行积分化简.
