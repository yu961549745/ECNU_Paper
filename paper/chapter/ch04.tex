...
\section{NEM软件包的实现}
在上文中, 我们以差分方程多项式解为例, 展示了$n$阶展开方法的作用. 实时上, $n$阶展开方法也能用于完善其它基于齐次平衡原则方法. 为了能够更加方便的将$n$阶展开方法应用到相关问题中去, 本文决定将$n$阶展开方法单独实现为一个NEM软件包.
...
基于NEM, 我们能够很方便的实现求解非线性差分方程多项式解的软件包NLREPS.
\begin{compactenum}[(1)]
...
在本章中, 我们提出了$n$阶展开方法来完善齐次平衡原则, 并将其应用于非线性差分方程多项式解的求解. 我们针对$n$阶展开方法开发了NEM, 并在此基础上开发了求解非线性差分方程多项式解的软件包NLREPS. 
