...
\section{$n$阶展开方法在\Painleve{}展开方法中的应用}\label{ch4sec6}
在\Painleve{}展开方法中, 我们取
\begin{equation}
...
接着, 我们以一个典型的例子来展示 NEM 在\Painleve{}展开方法中的应用.
...
事实上, 本文所实现的\Painleve{}展开方法能够自动导出变换$u=F(t)\sqrt{f_x}/f$, 但是我们不能以这个变换为基础进行后续的求解.  因此, 本文实现的 TwSolver 和 NS1L 都不能直接求解\refeqnn{raeq}. 但是, 这两个软件包都提供了自定义变换进行求解的功能.
...
在本章中, 我们提出了$n$阶展开方法来完善齐次平衡原则, 并将其应用于非线性差分方程多项式解的求解. 我们针对$n$阶展开方法开发了 NEM 软件包, 并在此基础上开发了求解非线性差分方程多项式解的软件包NLREPS. 同时, 我们还将$n$阶展开方法应用于微分方程的求解. 我们开发了基于双曲正切方法的 NCTM 和实现\Painleve{}展开方法的 PAnalyze. 
