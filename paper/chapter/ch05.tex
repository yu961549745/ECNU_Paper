...
接下来, 我们以几个典型的例子来展示NCTM的基本用法, 以及它相对于现有双曲正切函数法的软件包的改进. 
...
\section{小结}
在本节中, 我们以双曲正切方法和\Painleve{}分析为例, 展示了$n$阶展开方法在微分方程求解中的作用. 基于NEM实现的双曲正切方法软件包\cd{NTCM}能够求解任意维度的方程, 还能够求解其它双曲正切方法软件包不能求解的方程. 通过\Painleve{}中的一个例子, 也能够看出用$n$阶展开方法替代齐次平衡原则就能求解许多以往不能求解的问题. 
