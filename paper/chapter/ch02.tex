...
\begin{figure}[ht]
\centering 
\includegraphics[width=0.4\textwidth]{fig/lump_cmp.pdf}
...
\subfigure[BKP-T方程的1-孤子解 \label{bkp:1-soliton-t}]{
    \includegraphics[width=.28\textwidth]{fig/(2+1)BKP-T-1-soliton.png}
}
\subfigure[BKP方程的1-孤子解 \label{bkp:1-soliton}]{
    \includegraphics[width=.28\textwidth]{fig/(2+1)BKP-1-soliton.png}
}
\subfigure[BKP方程的2-孤子解 \label{bkp:2-soliton}]{
    \includegraphics[width=.28\textwidth]{fig/(2+1)BKP-2-soliton.png}
}
