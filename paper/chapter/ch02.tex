...
\red{展开介绍一下递归求解算法. 简单介绍一下齐次平衡原则的应用. 可以提一下n阶展开方法看下文. 然后那个神奇的例子不知道这里引出来不. 还要点明一点, 从最高次开始求解是为了不求解微分方程.}\todo{明天就补上}
...
事实上, $m$-lump 解生成公式中的项数, 是 OEIS A066223 的第$m$项, 满足 \footnote{OEIS A066223: \url{https://oeis.org/A066223}}
\begin{equation}
\begin{split}
N(m)&=\sum_{k=0}^m{\binom{2m}{2k}\sbrace{2k-1}!!} \\ 
    &=m! 2^m {\rm LaguerreL}\sbrace{m,-\frac{1}{2},-\frac{1}{2}}, 
\end{split}
\end{equation}
它的增长要比阶乘更快. 
