\chapter{\Painleve{}分析与非线性演化方程的三种波解}\label{ch02}
\section{\Painleve{}分析}
...
我们利用简单Hirota方法来构造NLEE的孤子解. 需要注意的是, 对于不可积的方程, 直接用简单Hirota方法的$m$-孤子解的公式所生成的孤子解在一定的约束条件下才是原方程的解. 我们的算法对于不可积的方程也是有效的. \mk{}{连接不连贯.}
...
因为1-孤子和2-孤子是通过待定系数法直接求解的, 所以它们必然满足原方程. 而1-呼吸子和1-lump是由2-孤子解生成的, 也不需要验证. 因此, 我们在实验中验证3-孤子解\zdh 2-呼吸子解和2-lump解. 表中`\VTRUE'表示得到的解是\TrueSol{}, `\VFALSE'表示得到的解是\FalseSol{}. 此外, `-'表示我们的方法不能得到解, 并且无解的原因会在最后一列给出. 
